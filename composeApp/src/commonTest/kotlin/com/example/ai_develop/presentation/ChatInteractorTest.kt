...
class ChatInteractorTest {
    ...
    private class MockUseCase(repo: ChatRepository, scope: CoroutineScope) : ChatStreamingUseCase(repo, ChatMemoryManager(), scope, testAgentToolRegistry(), EmptyMcpRepository()) {
