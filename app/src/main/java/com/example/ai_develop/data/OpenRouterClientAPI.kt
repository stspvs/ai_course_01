...
@Singleton
internal class OpenRouterClientAPI @Inject constructor(
        ...
        OkHttpClient.Builder()
            ...
            .addInterceptor { chain ->
                val request = chain.request().newBuilder()
                    ...
                    .addHeader("HTTP-Referer", "https://github.com/sts-dev/ai_develop") // Required by OpenRouter
                    .addHeader("X-Title", "AI Develop App")
                    .build()
                        ...
                        while (!source.exhausted()) {
                            ...
                            if (line.startsWith("data: ")) {
                                ...
                                try {
                                    ...
                                    // Skip invalid chunks or keep-alive
                                }
                            }
                        }
                    }
